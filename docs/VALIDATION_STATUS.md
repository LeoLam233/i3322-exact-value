...
| Item | Preserved status | What it means |
|---|---|---|
| R0 | CLOSED-PASS | Existential true-value outer carrier, within frozen premises |
| R1 | CLOSED-PASS | Exact finite lower/upper certificate validity |
| O1–O5 | CLOSED-PASS | D001 documentary provenance issue closed by the sealed supplement |
| O6 | OPEN-MINOR; SURVIVES | Complete matching-parameter theorem survives; M001 remains |
| Final clean O7/O8 integration | PASS relative to canonical components | `S_t=s_*` and strict rational enclosure |
| Final integrated hostile audit | OPEN-MINOR; THEOREM SURVIVES | One inherited minor M001; no unresolved load-bearing integration issue |
| Project source-provenance audit | OPEN-MINOR; THEOREM SURVIVES | Four minor/four documentation findings; no load-bearing source-text error |
| M001 in surviving O6 | OPEN; genuine; non-load-bearing; unpatched | Actual submitted midpoint uses were contained; synthetic helper failure remains |
| R1 released witness identity | Authenticated | Exact release bytes bound to the inspected source record |
