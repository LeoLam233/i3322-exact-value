...
The matching picture is not first introduced here: a related picture appeared
with the candidate constant in Douglas's v1.0.0 archive
~\cite{Douglas2026Zenodo}. The associated August proof claims were later
withdrawn. What is claimed in this section is the separate rigorous bridge
between the intrinsic full-state matching set of
Definition~\ref{def:matching} and the carriers used by the present proof,
together with the independently certified uniqueness architecture developed
